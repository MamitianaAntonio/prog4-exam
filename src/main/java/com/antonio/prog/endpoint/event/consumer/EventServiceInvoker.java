package com.antonio.prog.endpoint.event.consumer;

import com.antonio.prog.PojaGenerated;
import com.antonio.prog.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("com.antonio.prog.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "com.antonio.prog.service.event."
