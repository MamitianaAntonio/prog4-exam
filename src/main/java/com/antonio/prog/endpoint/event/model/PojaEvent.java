package com.antonio.prog.endpoint.event.model;

import static com.antonio.prog.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import com.antonio.prog.PojaGenerated;
import com.antonio.prog.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    if (getEventStack().equals(EVENT_STACK_1)) return "com.antonio.prog.event1";
    return "com.antonio.prog.event2";
  }
}
